package com.ttn.framework.tests.base;

import com.relevantcodes.extentreports.ExtentReports;
import com.relevantcodes.extentreports.ExtentTest;
import com.relevantcodes.extentreports.LogStatus;
import com.ttn.framework.utils.FileOperation;
import com.ttn.framework.utils.UIUtil;
...
public class BaseUtil {
    ...
    protected Properties config = initPropFromFile("/src/main/resources/config.properties");
    ...
    protected CommonScenarios commonScenarios;
    ...
    public static Properties getTestData(String filename) {
        ...
        try {
            FileInputStream fs = new FileInputStream(directory.getCanonicalPath() + File.separator +
                    ...
                    File.separator + "ttn" + File.separator +
                    "framework" + File.separator + "testdata" + File.separator + filename);
            temp.load(fs);
    ...
    private String getEnvironmentURL(String environment) {
        switch (environment.toUpperCase()) {
            ...
            case "AUTO":
                return "http://vps-auto.westcon.com/";
            case "RUN":
    ...
    private synchronized WebDriver initDriver(String browser) {
        String os = BaseClass.os;
        String driversPath = "/lib/";
        try {
            driversPath = BaseClass.directory.getCanonicalPath() + File.separator + "lib" + File.separator +
    ...
    private FirefoxProfile setFirefoxProfile() {
        ...
        profile.setPreference("browser.download.dir", BaseClass.fileDownloadPath);
    ...
    private DesiredCapabilities setChromeCaps(String browserType) {
        ...
        chromePrefs.put("download.default_directory", BaseClass.fileDownloadPath);
